...
import KET from "../assets/projects/KET.jpeg";
        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={KET}
              isBlog={false}
              title="Keyword-Extraction-Techniques(Python)"
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              demoLink="https://shree-media-app.netlify.app/"
            />
          </Col>
